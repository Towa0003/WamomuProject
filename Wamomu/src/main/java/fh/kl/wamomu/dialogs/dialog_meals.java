...
public class dialog_meals extends Dialog {
    ...
    TextView t;
    EditText timepicker, mealedit, datepicker;
    Button btnadd;
    Spinner spMealGroup;

    public dialog_meals(Context context) {
        super(context);
        ...
        setOnCancelListener(new DialogInterface.OnCancelListener() {
            public void onCancel(DialogInterface dialog) {
                ...
                MealsFragment.meals = 0;

            }
        });

        TextView text = (TextView) findViewById(R.id.tv_mealtext);
        text.setText("Mahlzeit hinzufügen");
        ImageView image = (ImageView) findViewById(R.id.iv_mealimage);
        image.setImageResource(R.drawable.mahlzeit);

        mealedit = (EditText) findViewById(R.id.et_mealedit);

        btnadd = (Button) findViewById(R.id.bt_add);
        timepicker = (EditText) findViewById(R.id.et_timeedit);
        ...
        timepicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(getOwnerActivity(), new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        datepicker = (EditText) findViewById(R.id.et_dateedit);
        ...
        datepicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatePicker = new DatePickerDialog(getOwnerActivity(), new DatePickerDialog.OnDateSetListener() {
...
//            Hinzufügen Button in Dialog
        btnadd.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Toast.makeText(getOwnerActivity(), "Meal added", Toast.LENGTH_SHORT).show();
                dismiss();
                MealsFragment.meals = 0;
            }
        });
        ...
        DialogInterface.OnDismissListener listener = new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                FragmentTransaction ft = mf.getFragmentManager().beginTransaction();
